 ...
 * @author jeoli
 */
public class LoginGerenciarView extends javax.swing.JFrame {

    /**
     * Creates new form LoginGerenciarView
     */
    public LoginGerenciarView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginGerenciarView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
